...
2. copy the "multi_io" directory from this repository and its contents into the `./things` folder. In the end, `./things/multi_io` should have the following structure:
```
./things/multi_io/
  circuit/
    images/
